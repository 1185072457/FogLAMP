...
"""HTTP Listener handler for sensor phone application readings
   See: https://itunes.apple.com/ca/app/sensorphone/id1092304193?mt=8 for IOS

   Setup the IoT service on the phone app to point to the FogLAMP URL
   as defined in the configuration of this plugin. Select POST to send
   data to FogLAMP. To continuely send data set the interval for readings
   and select POST.
"""
import sys
